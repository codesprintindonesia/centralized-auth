...
const swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "API untuk sistem otentikasi terpusat dengan signature asimetris",
      contact: {
        name: "Admin",
    ...
    components: {
      securitySchemes: {
        ...
        SignatureAuth: {
          ...
          name: "X-Signature",
          description:
            "Tanda tangan digital untuk verifikasi integritas request",
        },
      },
      schemas: {
        // Response schemas
        ...
        DisableMfaRequest: {
          ...
          properties: {
            current_password: {
              ...
              description: "Password saat ini untuk verifikasi",
            },
          },
        },
        MfaSetupResponse: {
          ...
          properties: {
            ...
            message: {
              type: "string",
              example: "TOTP setup berhasil dibuat",
            },
            data: {
              type: "object",
              properties: {
